...
export const BreakGuideModal: React.FC<BreakGuideModalProps> = ({
  ...
  const [currentSession, setCurrentSession] = useState<BreakSession | null>(
    null
  );
      ...
      >
        <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
          ...
          >
            ...
            >
              {currentSession.activities.length} aktivite •{' '}
              {currentSession.totalDuration} dakika
            </Text>
            <Text
              style={{
                fontSize: 14,
    ...
    >
      <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
        ...
        >
          ...
          >
            Mola sürenizi en verimli şekilde değerlendirin. Stretching, nefes
            egzersizleri ve diğer aktivitelerle enerjinizi yenileyin.
          </Text>
        </View>
