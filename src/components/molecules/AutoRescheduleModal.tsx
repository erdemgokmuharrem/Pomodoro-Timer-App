...
export const AutoRescheduleModal: React.FC<AutoRescheduleModalProps> = ({
  ...
  const { settings, updateSettings, energyLevel, consecutivePomodoros } = useAutoRescheduleStore();
  ...
  const getEnergyLevelText = (level: string) => {
    switch (level) {
      case 'high': return 'Yüksek Enerji';
      case 'medium': return 'Orta Enerji';
      case 'low': return 'Düşük Enerji';
          ...
          <Card style={{ marginBottom: 20 }}>
            ...
            <View style={{
              ...
              <Switch
                ...
                thumbColor={localSettings.enabled ? theme.colors.background : theme.colors.textSecondary}
              />
            </View>
            ...
            <View style={{
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
                thumbColor={localSettings.autoStartNextTask ? theme.colors.background : theme.colors.textSecondary}
              />
            </View>
            ...
            <View style={{
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
                thumbColor={localSettings.autoStartBreak ? theme.colors.background : theme.colors.textSecondary}
              />
            </View>
          </Card>
          ...
          <Card style={{ marginBottom: 20 }}>
            ...
            <View style={{
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
                thumbColor={localSettings.priorityBased ? theme.colors.background : theme.colors.textSecondary}
              />
            </View>
            ...
            <View style={{
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
                thumbColor={localSettings.energyBased ? theme.colors.background : theme.colors.textSecondary}
              />
            </View>
          </Card>
            ...
            <View style={{
              ...
              <TouchableOpacity
                onPress={() => setLocalSettings({
                  ...localSettings,
                  maxConsecutivePomodoros: Math.max(1, localSettings.maxConsecutivePomodoros - 1),
                })}
                style={{
                  width: 40,
                  height: 40,
              ...
              >
                <Text style={{ color: theme.colors.background, fontSize: 20 }}>-</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                onPress={() => setLocalSettings({
                  ...localSettings,
                  maxConsecutivePomodoros: Math.min(10, localSettings.maxConsecutivePomodoros + 1),
                })}
                style={{
                  width: 40,
                  height: 40,
