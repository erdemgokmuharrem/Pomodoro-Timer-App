...
export const useContextFilters = () => {
  ...
  const createFilterGroups = useCallback(() => {
    ...
    const priorityFilters: ContextFilter[] = [
      { id: 'priority-high', name: 'Yüksek Öncelik', type: 'priority', value: 'high', color: '#EF4444', icon: '🔴' },
      { id: 'priority-medium', name: 'Orta Öncelik', type: 'priority', value: 'medium', color: '#F59E0B', icon: '🟡' },
      { id: 'priority-low', name: 'Düşük Öncelik', type: 'priority', value: 'low', color: '#10B981', icon: '🟢' },
    ];
    ...
    const durationFilters: ContextFilter[] = [
      { id: 'duration-short', name: 'Kısa (1-2 pomodoro)', type: 'duration', value: 'short', color: '#3B82F6', icon: '⏱️' },
      { id: 'duration-medium', name: 'Orta (3-4 pomodoro)', type: 'duration', value: 'medium', color: '#8B5CF6', icon: '⏰' },
      { id: 'duration-long', name: 'Uzun (5+ pomodoro)', type: 'duration', value: 'long', color: '#EF4444', icon: '⏳' },
    ];
    ...
    const statusFilters: ContextFilter[] = [
      { id: 'status-completed', name: 'Tamamlanan', type: 'status', value: 'completed', color: '#10B981', icon: '✅' },
      { id: 'status-pending', name: 'Bekleyen', type: 'status', value: 'pending', color: '#F59E0B', icon: '⏳' },
      { id: 'status-in-progress', name: 'Devam Eden', type: 'status', value: 'in-progress', color: '#3B82F6', icon: '🔄' },
    ];
    ...
    const dateFilters: ContextFilter[] = [
      { id: 'date-today', name: 'Bugün', type: 'date', value: 'today', color: '#3B82F6', icon: '📅' },
      { id: 'date-yesterday', name: 'Dün', type: 'date', value: 'yesterday', color: '#6B7280', icon: '📆' },
      { id: 'date-this-week', name: 'Bu Hafta', type: 'date', value: 'this-week', color: '#8B5CF6', icon: '📊' },
    ];
  ...
  // Toggle filter
  const toggleFilter = useCallback((filter: ContextFilter) => {
