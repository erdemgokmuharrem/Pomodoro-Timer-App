...
export const useAccessibility = () => {
  ...
  const updateColorScheme = (colorScheme: AccessibilitySettings['colorScheme']) => {
  ...
  const getTimerAccessibilityProps = (timeLeft: number, isRunning: boolean, isBreak: boolean) => {
  ...
  const getProgressAccessibilityProps = (current: number, total: number, label: string) => {
